...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('gpm_edom_periods', function (Blueprint $table) {
            ...
            $table->text('instructions')->nullable(); // Instructions for students
            
            // Settings
            $table->boolean('is_active')->default(false);
            $table->boolean('is_published')->default(false); // Results published
            $table->boolean('require_all_courses')->default(true);
