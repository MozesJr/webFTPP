...
return new class extends Migration
{
     ...
     * 
     * Table: gpm_settings
     * Purpose: Menyimpan konfigurasi dan pengaturan GPM
     * Optional: Bisa digunakan untuk menyimpan berbagai setting
     */
    public function up(): void
    {
        Schema::create('gpm_settings', function (Blueprint $table) {
            ...
            $table->text('value')->nullable(); // setting value (bisa JSON)
            $table->string('type')->default('string'); // string, json, boolean, integer
            $table->string('group')->nullable(); // grouping settings (e.g., 'edom', 'survey', 'general')
            ...
            // Metadata
            $table->boolean('is_public')->default(false); // bisa diakses public atau admin only
        ...
        DB::table('gpm_settings')->insert([
            ...
            [
                ...
                'description' => 'Maximum file size for document upload (in KB)',
                'is_public' => false,
                'created_at' => now(),
                'updated_at' => now(),
            ],
