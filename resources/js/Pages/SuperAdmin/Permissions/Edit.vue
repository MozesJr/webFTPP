            ...
            <form @submit.prevent="handleSubmit" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Gunakan format: module.action (contoh: users.view, posts.create, roles.delete)
                    </p>
                ...
                <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
                    <h3 class="text-sm font-medium text-blue-800 mb-2">Informasi Permission</h3>
                    <div class="text-sm text-blue-700">
                        <p><strong>Guard:</strong> {{ permission.guard_name }}</p>
                        <p><strong>Dibuat:</strong> {{ formatDate(permission.created_at) }}</p>
                        <p><strong>Terakhir diubah:</strong> {{ formatDate(permission.updated_at) }}</p>
                    </div>
                </div>
...
const handleSubmit = () => {
    ...
    form.put(route('super-admin.permissions.update', props.permission.id), {
        onSuccess: () => {
