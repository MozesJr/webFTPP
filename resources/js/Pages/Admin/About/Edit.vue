                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">
                            Perbarui informasi about fakultas
                        </p>
                    </div>
                    <Link
                        href="/admin/about"
                    ...
                    >
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div
                                    v-if="currentSecondaryImageUrl"
                                    class="mb-3"
                                >
                                    <img
                                        :src="currentSecondaryImageUrl"
                                        alt="Current Secondary Image"
                                        class="w-full h-32 object-cover rounded-lg"
                                    />
                                    <p class="text-xs text-gray-500 mt-1">
                                        Gambar kedua saat ini
                                    </p>
                                </div>
...
const form = useForm({
    ...
    image_url: null,
    video_url: props.about?.video_url || "",
    video_title: props.about?.video_title || "",
    video_description: props.about?.video_description || "",
