...
const submit = () => {
    form.post(route("admin.gpm.struktur-organisasi.store"), {
        preserveScroll: true,
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Tambahkan anggota baru ke Struktur Organisasi GPM
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input
                                v-model="form.nama"
                                type="text"
                                placeholder="Dr. Ahmad Hidayat, S.T., M.T."
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea
                                ...
                                rows="4"
                                placeholder="Deskripsi tugas dan fungsi dalam organisasi GPM..."
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                :class="{
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea
                                v-model="form.bio"
                                rows="3"
                                placeholder="Informasi tambahan tentang anggota..."
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
