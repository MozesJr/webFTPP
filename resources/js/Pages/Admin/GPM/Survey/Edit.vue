...
const form = useForm({
    ...
    target_respondent: props.survey.target_respondent,
    start_date: props.survey.start_date,
    end_date: props.survey.end_date,
    is_active: props.survey.is_active,
...
const submit = () => {
    form.post(route('admin.gpm.survey.update', props.survey.id), {
        preserveScroll: true,
    });
};
</script>
        ...
        <div class="py-6">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-6">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Edit Survey</h2>
                    <p class="mt-1 text-sm text-gray-500">Edit informasi dan pertanyaan survey</p>
                </div>

                <form @submit.prevent="submit" class="space-y-6">
                    <!-- Basic Info -->
                    <div class="bg-white shadow rounded-lg p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Informasi Survey</h3>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="flex items-center">
                                    ...
                                    />
                                    <span class="ml-2 text-sm text-gray-700">Aktifkan survey</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">
                            Pertanyaan Survey
                            <span class="text-sm font-normal text-gray-500">({{ form.questions.length }} pertanyaan)</span>
                        </h3>

                        <!-- Add Question Form -->
                        <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <h4 class="text-sm font-medium text-blue-900 mb-3">Tambah Pertanyaan</h4>
                            ...
                            <!-- Options (if needed) -->
                            <div v-if="needsOptions(newQuestion.type)" class="mt-3">
                                <input
                        ...
                        <div v-if="form.questions.length > 0" class="space-y-3">
                            ...
                            >
                                <!-- Order Number -->
                                <div class="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-blue-600 text-white rounded-full text-sm font-medium">
                                    {{ question.order }}
                                </div>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="mt-1 flex items-center gap-3 text-xs text-gray-500">
                                        ...
                                        <span v-if="question.is_required" class="text-red-600">● Wajib</span>
                                        <span v-if="question.options" class="truncate max-w-xs">
                        ...
                        <div v-else class="text-center py-12 text-gray-500">
                            ...
                            <p class="mt-2 text-sm">Belum ada pertanyaan. Tambahkan pertanyaan di atas.</p>
                        </div>
                    </div>
