                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">
                            Edit informasi anggota tim {{ team.name }}
                        </p>
                    </div>
...
const form = useForm({
    ...
    position_id: props.team.position_id || "",
    prodi_id: props.team.prodi_id || "",
    email: props.team.email || "",
    phone: props.team.phone || "",
    bio: props.team.bio || "",
    photo: null,
    education: props.team.education || "",
    expertise: props.team.expertise || "",
    is_active: props.team.is_active || false,
    order_index: props.team.order_index || null,
    _method: "PUT",
});
...
const submit = () => {
    form.post(`/admin/team/${props.team.id}`, {
        forceFormData: true,
        preserveScroll: true,
    });
};
