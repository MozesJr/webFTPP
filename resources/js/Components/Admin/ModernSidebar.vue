    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <div class="px-4 space-y-1">
                ...
                <!-- Web Console — hanya untuk superadmin@faculty.ac.id -->
                <template v-if="user?.email === 'superadmin@faculty.ac.id'">
                    <div class="py-2">
                        <div class="border-t border-gray-200"></div>
                        <span class="text-xs font-semibold text-purple-500 uppercase tracking-wider px-3 py-2 block">
                            Developer Tools
                        </span>
                    </div>
                    <SidebarItem
                        href="/super-admin/terminal"
                        :active="currentUrl.startsWith('/super-admin/terminal')"
                        icon="CogIcon"
                    >
                        Web Console
                    </SidebarItem>
